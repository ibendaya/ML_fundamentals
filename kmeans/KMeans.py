...
class KMeans:
    ...
    def predict(self, X):
        ...
        # classify samples as index of their cluster
        return self._get_cluster_labels(self.clusters)

    def _get_cluster_labels(self, clusters):
        # each sample gets label it was assigned to
    ...
    def _is_converged(self, old_centroids, new_centroids):
        distances = [
            euc_dist(old_centroids[i], new_centroids[i]) for i in range(self.k)
        ]
